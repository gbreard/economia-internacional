        ...
        if level == 0:
            ...
            if sub_items:
                ...
                html_parts.append(
                    ...
                    f'\n<ul style="margin-top: 5px; padding-left: 1.2em; font-size: {sub_font}; color: {sub_color}; list-style-type: disc;">'
                    f'\n{sub_html}\n</ul></li>')
                i = j
            else:
...
def render_texto(s, active):
    ...
    layout = s.get('layout', '')
    li_m = '8px' if layout == 'dos-columnas' else '12px'
    items = build_items_html(s.get('contenido', []), li_margin=li_m)
  ...
  ">
    ...
    {sub}
    <ul{ul_extra} style="font-size: {ul_font}; color: #111827; line-height: {ul_lh}; padding-left: 1.5em; flex-grow: 1;">
{items}
    </ul>
  </section>'''
...
<head>
  ...
  <title>Economía Internacional - Clase 5</title>
...
<div class="footer">
  <span>Economía Internacional | UMET | Clase 5</span>
