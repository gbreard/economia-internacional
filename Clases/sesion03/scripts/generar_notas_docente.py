#!/usr/bin/env python3
"""
Genera un documento Word compacto con todas las notas docente de la Clase 3.
"""
import sys, os, re
...
add_run(p, 'NOTAS DOCENTE — CLASE 3', bold=True, size=20, color=(0x1F, 0x4E, 0x79))

p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
add_run(p, 'Economía Internacional — UMET 2026\n', size=12, color=(0x4B, 0x55, 0x63))
add_run(p, 'Del modelo neoclásico a Heckscher-Ohlin: dotaciones, distribución y evidencia\n', size=11, color=(0x4B, 0x55, 0x63))
add_run(p, 'Jueves 09/04/2026 — 18:00 a 22:00 — 43 slides', size=11, color=(0x4B, 0x55, 0x63))
...
# --- Guardar ---
output_path = os.path.join(script_dir, '..', 'Notas_Docente_Clase3.docx')
