...
def render_centrado(s, active):
    sub = f'<p style="color: #111827; font-size: 1.3rem; font-weight: 600; margin-bottom: 30px; text-align: center; max-width: 80%;">{esc(s.get("subtitulo", ""))}</p>' if s.get('subtitulo') else ''
