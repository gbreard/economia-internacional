...
def render_grafico_texto(s, active):
    ...
    # Imágenes de img/ (retratos, fotos) usan layout 33/rest; gráficos usan 62/rest
    is_portrait = 'img/' in s.get('visual', '')
    img_pct = '33' if is_portrait else '62'
    return f'''
  <section class="slide{active}" style="
    background-color: #FFFFFF;
    display: flex; flex-direction: column;
...
<head>
  ...
  <title>Economía Internacional - Clase 4</title>
...
<div class="footer">
  <span>Economía Internacional | UMET | Clase 4</span>
