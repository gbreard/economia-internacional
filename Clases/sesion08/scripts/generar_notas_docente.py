...
add_run(p, 'NOTAS DOCENTE — SESIÓN 8', bold=True, size=20, color=(0x1F, 0x4E, 0x79))

p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
add_run(p, 'Economía Internacional — UMET 2026\n', size=12, color=(0x4B, 0x55, 0x63))
add_run(p, 'Unidad 5 (parte 1) — Empresas transnacionales, IED y cadenas globales de valor\n', size=11, color=(0x4B, 0x55, 0x63))
add_run(p, f'Jueves 04/06/2026 — 18:00 a 22:00 — {len(slides)} slides', size=11, color=(0x4B, 0x55, 0x63))
...
output_path = os.path.join(script_dir, '..', 'Notas_Docente_Sesion8.docx')
